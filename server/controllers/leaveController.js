...
import { leaveRequestTemplate } from "../utils/emailTemplates.js";
...
export const approveLeave = async (req, res) => {
  try {
    ...
    // ===========================
    // STEP 6: NOTIFY EMPLOYEE (APPROVED)
    // ===========================
    ...
    await sendEmail(
      ...
      leaveApprovedTemplate(employee.name, leave.type)
    );
...
export const rejectLeave = async (req, res) => {
  try {
    ...
    // ===========================
    // STEP 6: NOTIFY EMPLOYEE (REJECTED)
    // ===========================
    const employee = await User.findById(leave.employee);
    ...
    await sendEmail(
      ...
      leaveRejectedTemplate(employee.name, leave.type)
    );
